...
<body>
	<c:forEach var="f" items="${files }">
		<table class="anImg">
			<tr>
				<td align="center">
					<a href="resources/img/${f.dg_file }"><img src="resources/img/${f.dg_file }"></a> 
				</td>
			</tr>
			<tr> 
			...
			<tr>
				<c:choose>
					<c:when test="${f.dg_owner == sessionScope.loginMember.dm_id }">
						<td align="right" onclick="galleryDelete(${f.dg_no}, '${f.dg_file }');" class="afOwner" style="cursor:pointer;">${f.dg_owner }&nbsp;</td>
					</c:when>
					<c:otherwise>
				...
				<td align="center">
					<form action="gallery.upload" method="post" 
						...
						style="color: white; font-family: 'c'; font-size: 15pt;">
							<tr>
								<td id="swtTd1">
									<input name="dg_title" placeholder="제목" maxlength="25" autocomplete="off" id="dutInput">
									<input name="dg_file" type="file" style="font-family: 'c'; font-size: 14pt;">
								</td>
